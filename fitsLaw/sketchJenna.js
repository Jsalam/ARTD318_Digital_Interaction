...
var inputValue;
    ...
    p5.draw = function(){
        ...
        mouseEnabled = !p5.mouseIsPressed;
    ...
    var makeGUI = function(){
        ...
        inputValue = p5.createInput('Number of shapes');
    ...
    var myInputEvent = function() {
        console.log('you are typing: ', this.value());
        if (!isNaN(this.value())){
            numberShapes = this.value();
        } else {
            p5.text('Invalid number ' + this.value() , 300, 50 );
        }
    }
